...
const OPPORTUNITIES_DATA: Opportunity[] = [
  ...
  },
  {
    ...
    description: '১৮ বিধ পৰম্পৰাগত কাৰিকৰ (মিস্ত্ৰী, কমাৰ, কুমাৰ, কাঠমিস্ত্ৰী ইত্যাদি)ৰ বাবে বিনামূলীয়া প্ৰশিক্ষণ, ₹১,০০০ টুলকিট অনুদান আৰু কম সুতৰ ঋণ।'
  },
  {
    id: 'cmaaa-assam-2026',
...
export const Opportunities: React.FC = () => {
   ...
   *
   * Uses window.open() instead of relying on an <a href>
   * so the share action is explicitly triggered by the
   * user's click.
   */
  const handleWhatsAppShare = (item: Opportunity) => {
    ...
    /*
     * Some browsers can block popups. If window.open()
     * returns null, use the current window as fallback.
     */
    if (!newWindow) {
